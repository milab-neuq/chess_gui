...
def create_game(width):
    ...
    dots = frozenset((i, j) for i in range(width+1) for j in range(width+1))
    boxes = frozenset((i, j) for i in range(width) for j in range(width))
    h_lines = frozenset((i, j) for i in range(width) for j in range(width+1))
    v_lines = frozenset((i, j) for i in range(width+1) for j in range(width))
