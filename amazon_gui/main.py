...
WIDTH = 800
HEIGHT = 540
MARGIN = int(HEIGHT / 12)                     #边缘留余
GRID = int(HEIGHT / 12)                       #方格宽度：45
CHESS_PIECE = 45                         #棋子大小
ARROW_PIECE = 40                         #箭大小
EMPTY = 0
BLACK = 1
...
class Amazon(QWidget):
    ...
    def initUI(self):
        ...
        self.black_txv.resize(180, 50)
        self.black_txv.move(500, 100)
        ...
        self.race_place_txv.resize(180, 50)
        self.race_place_txv.move(500, 140)
        ...
        self.race_name_txv.resize(180, 50)
        self.race_name_txv.move(500, 175)
        ...
        self.chess_score_btn.move(490, 230)  # 设置按钮在窗口中的位置
        ...
        self.regretBtn.move(370, 230)  # 设置按钮在窗口中的位置
        ...
        self.select_first_Btn.move(720, 230)
        ...
        self.info_button_txv.resize(430, 50)
        self.info_button_txv.move(370, 285)
        ...
        self.commite_btn.resize(180, 60)
        self.commite_btn.move(500, 330)
        ...
        self.tishi_txv.resize(250, 100)
        self.tishi_txv.move(490, 400)
